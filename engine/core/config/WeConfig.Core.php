...
$config['base_url'] 	= 'acquacolor/site';
...
/*
	Definição de temas
 */
$config['themes'] = array('site', 'we-framework');
...
$config['htaccess_param_url'] = array('mode', 'page', 'subpage', 'content', 'action', 'naction');
